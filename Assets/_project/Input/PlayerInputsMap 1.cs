...
//     version 1.14.2
//     from Assets/_project/Input/PlayerInputsMap 1.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/_project/Input/PlayerInputsMap 1.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @PlayerInputsMap1: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @PlayerInputsMap1()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""PlayerInputsMap 1"",
    ""maps"": [
        {
            ""name"": ""MenuMap"",
    ...
    ~@PlayerInputsMap1()
    {
        UnityEngine.Debug.Assert(!m_MenuMap.enabled, "This will cause a leak and performance issues, PlayerInputsMap1.MenuMap.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_InGameMap.enabled, "This will cause a leak and performance issues, PlayerInputsMap1.InGameMap.Disable() has not been called.");
    }
    ...
    {
        private @PlayerInputsMap1 m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public MenuMapActions(@PlayerInputsMap1 wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct InGameMapActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public InGameMapActions(@PlayerInputsMap1 wrapper) { m_Wrapper = wrapper; }
        /// <summary>
